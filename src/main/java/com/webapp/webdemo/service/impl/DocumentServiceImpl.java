...
public class DocumentServiceImpl implements DocumentService {
    ...
    public Resource downloadFile(UsernamePasswordAuthenticationToken principal, Long documentNo) {
        ...
        if(documentOptional.isPresent()){
            ...
            log.info("Before: {}", document.getFileName());
            document.setFileName("Bao test");
            log.info("After: {}", document.getFileName());
    ...
    public DocumentResponse getDetailDocument(Long documentNo) {
        List<UserDocument> userDocuments = userDocumentRepository.findByDocument_DocumentNo(documentNo);
