...
public interface UserDocumentRepository extends JpaRepository<UserDocument, Long> {
    ...
    List<UserDocument> findByDocument_DocumentNo(Long documentNo);
    Optional<UserDocument> findByDocument_DocumentNoAndPermissionNameEquals(Long documentNo, PermissionName permissionName);
}
